        ...
        if vacancy['salary'] is not None:
            ...
            if salary['from'] is not None:
                ...
                if salary['currency'] == 'USD':
                    list_floor_salary.append(salary['from'] * USD_to_RUR)
                elif salary['currency'] == 'EUR':
                    list_floor_salary.append(salary['from'] * EUR_to_RUR)
                else:
                    list_floor_salary.append(salary['from'])
            ...
            if salary['to'] is not None:
                ...
                if salary['currency'] == 'USD':
                    list_ceiling_salary.append(salary['to'] * USD_to_RUR)
                elif salary['currency'] == 'EUR':
                    list_ceiling_salary.append(salary['to'] * EUR_to_RUR)
                else:
                    list_ceiling_salary.append(salary['to'])
    return int(median(list_ceiling_salary)), int(median(list_floor_salary)), ret_number_of_vacancies
